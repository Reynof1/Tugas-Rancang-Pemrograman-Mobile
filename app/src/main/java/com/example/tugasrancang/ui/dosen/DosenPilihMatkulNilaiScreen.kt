...
@Composable
fun DosenPilihMatkulNilaiScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Pilih Matakuliah untuk Input Nilai") },
                navigationIcon = {
                ...
                LazyColumn(
                    ...
                    items(matkulList) { matkul ->
                        MatkulCard(matkul = matkul, onClick = {
                            // Navigasi ke layar input nilai dengan membawa kode kelas
                            navController.navigate("dosen_input_nilai/${matkul.id}")
                        })
                    }
                }
            }
